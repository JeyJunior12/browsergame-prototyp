...
- **Offene Bilder:** `bilder-neu/BILDERLISTE.md` = geprüfte Liste aller fehlenden/doppelten Bilder (123) mit Vorschlag, Dateiname, Größe und Stil. Bilder erzeugt der Nutzer lokal (image-generation-mcp mit Forge, nur auf seinem PC erreichbar) → Ordner `bilder/`, WebP.
